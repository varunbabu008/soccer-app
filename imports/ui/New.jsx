...
export default class New extends Component{
  ...
  submitPlayer(event){
    ...
    console.log("success.player inserted");
    browserHistory.push('/');
        ...
        <div className="row">
          <div className="input-field col s6">
            ...
            <select className="browser-default" ref="ballManipulation">
              <option value="0"> Hasnt demonstrated ability</option>
              <option value="1"> Needs improvement</option>
              <option value="2"> Skill acquired</option>
              <option value="3"> Great skill</option>
            </select>
          </div>
